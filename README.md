...
We adding containerization via Visual Studio tooling 

Start folder contains the monolith with files prepared for the split

End folder contains solution with two projects.
